...
describe('constraints/spec', () => {
  ...
  describe('preferredOrdinalAxis', () => {
    it('should return true if both axes are ordinal', () => {
      ...
      assert.isTrue(SPEC_CONSTRAINT_INDEX['preferredOrdinalAxis'].satisfy(specM, schema, stats, defaultOpt));
    });
    ...
    it('should return true if the preferred axis is binned', () => {
      ...
      assert.isTrue(SPEC_CONSTRAINT_INDEX['preferredOrdinalAxis'].satisfy(specM, schema, stats, {preferredOrdinalAxis: Channel.Y}));
    ...
    it('should return false if the non-preferred axis is the only one that is temporal', () => {
      ...
      assert.isFalse(SPEC_CONSTRAINT_INDEX['preferredOrdinalAxis'].satisfy(specM, schema, stats, defaultOpt));
